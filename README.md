...
| ------------------------ | ------------------------------------------------------------------------------------- |
| Apple Silicon (M1/M2/M3) | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_aarch64.dmg |
| Intel                    | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_x64.dmg     |
...
| Format | Download                                                                                |
| ------ | --------------------------------------------------------------------------------------- |
| MSI    | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_x64_en-US.msi |
| EXE    | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_x64-setup.exe |
...
| Format   | Download                                                                                 |
| -------- | ---------------------------------------------------------------------------------------- |
| AppImage | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_amd64.AppImage |
| Deb      | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume_0.6.0_amd64.deb      |
| RPM      | https://github.com/Axiome-Apps/Plume/releases/download/v0.6.0/Plume-0.6.0-1.x86_64.rpm   |
